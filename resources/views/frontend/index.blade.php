...
@section('content')
    ...
    <div class="py-2">
        <div class="container  d-flex align-items-center justify-content-around p-4">
            ...
            <h3 style="font-size: ; font-weight:bolder; padding:5px;">Restaurant List</h3>
            <div class="border border-dark " style="width:20rem; background:black;"></div>
        </div>
    </div>
    <div class="py-5">
            ...
            <div class="row">
                    ...
                    <a  href="{{url('/category')}}" class="card col-md-4 " style="border:none;">
                        <div class="card-body zoom postion-relative">
                            <img src="{{asset('images\fried-chicken-breast-cheese-tomato-french-fries-ketchup-green-salad-side-view-jpg.jpg')}}"  class="w-100 lazy rounded" height="200px"   alt="">
                            <div class="text-light position-absolute top-50 start-50 translate-middle">
                                <h4 style="letter-spacing:3px; ">Restu Anak Cafe</h4>
                            </div>
                        </div>
                    </a>
                    <a href="{{url('/category')}}"   class="card col-md-4 " style="border:none;">
                        <div class="card-body zoom postion-relative">
                            <img src="{{asset('images\fried-chicken-breast-cheese-tomato-french-fries-ketchup-green-salad-side-view-jpg.jpg')}}"  class="w-100 lazy rounded" height="200px"  alt="">
                            <div class="text-light position-absolute top-50 start-50 translate-middle">
                                <h4 style="letter-spacing:3px; ">Pak Atong Cafe</h4>
                            </div>
                        </div>
                    </a>
                    <a href="{{url('/category')}}" class="card col-md-4 " style="border:none;">
                        <div class="card-body zoom postion-relative">
                            <img src="{{asset('images\fried-chicken-breast-cheese-tomato-french-fries-ketchup-green-salad-side-view-jpg.jpg')}}"  class="w-100 lazy rounded" height="200px"  alt="">
                            <div class="text-light position-absolute top-50 start-50 translate-middle">
                                <h4 style="letter-spacing:3px; ">SDAP Kitchen</h4>
                            </div>
                        </div>
                    </a>
